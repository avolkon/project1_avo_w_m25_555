...
ROOMS = {
    ...
    'armory': {
        'description': 'Старая оружейная комната. На стене висит меч, рядом — небольшой свиток.',
        'exits': {'south': 'library'},
        'items': ['sword'],
        'puzzle': (
            'В свитке написано: Этот меч достанется тому, кто первый разгадает мою загадку:\n"Я мягкий, как пух, но ломаю деревья. \nЯ тихий, как шёпот, но рву паруса. \nЧто я?\n(ответ - 1 слово маленькими буквами)"',
            'ветер'
        )
    },
    ...
    'secret_island': {
        'description': 'У берега подземного озера маленькая лодка,\nкоторая поможет добраться до острова в центре Источника.\nНа острове расположено то, что поможет тебе победить в игре.\nСадись в лодку и, когда прибудешь на остров, разгадай загадку.',
        'exits': {'south': 'underground_spring'},
        'items': ['bronze_box'],
        'puzzle': ( 
            'На дне лодки бутылка с запиской, это загадка, которую нужно разгадать: "Я бегу, но не устаю.\nЯ меняю форму, но не суть.\nЯ бываю мягка, как шёлк,\nИли тверда, как сталь.\nКто я?"\n(ответ - 1 слово маленькими буквами)',
            'вода'
        )
    }
